...
function GitHubButton({ stars }: { stars: number | null }) {
  return (
    <a
      ...
      onMouseEnter={e => { const el = e.currentTarget; el.style.background = 'var(--github-bg-hover)'; el.style.borderColor = 'var(--github-border-hover)'; el.style.color = 'var(--text-primary)'; }}
      onMouseLeave={e => { const el = e.currentTarget; el.style.background = 'var(--github-bg)'; el.style.borderColor = 'var(--github-border)'; el.style.color = 'var(--text-secondary)'; }}
    >
      ...
      {stars !== null && stars >= 1000 && (
        <span style={{
          ...
          background: 'var(--github-bg-hover)', borderRadius: 10, padding: '1px 6px', fontSize: 11,
        }}>
